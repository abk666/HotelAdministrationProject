...
//		}else {
//			Admin adminUpdated = new Admin(this.adminId, firstName, lastName, username, email, password, phone, address, dob, status, image);
//			
...
//					deletedFile.delete();
//					
//					File imageFile = new File("src/img/admin/"+image);
//					
//					BufferedImage bufferedImage = SwingFXUtils.fromFXImage(imageAdmin.getImage(), null);
//					
//					ImageIO.write(bufferedImage, "jpg", imageFile);
